        ...
        stage ('Deploy') {
            ...
            steps {
                sshagent(credentials: ['cloudlab']) {
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no eg983582@130.127.132.204 kubectl apply -f /users/lngo/deployment.yml -n jenkins'
                    sh 'ssh -o StrictHostKeyChecking=no eg983582@130.127.132.204 kubectl apply -f /users/lngo/service.yml -n jenkins'                                        
                }
            }
        }
    }
